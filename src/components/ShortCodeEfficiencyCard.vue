    ...
    <div class="card-header">
      <div class="header-content">
        ...
        <div class="header-buttons">
          <button @click="refreshData" class="refresh-btn" :disabled="isLoading" title="刷新計算">
            <svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor" :class="{ 'spinning': isLoading }">
