...
const DuplicatePage: React.FC = () => {
  ...
  const 重新計算 = async () => {
    ...
    try {
      ...
      // 計算繁簡聯合字頻（北語 + 臺標）
      const 繁簡聯合字頻 = await 字頻表服務.計算繁簡聯合字頻()
